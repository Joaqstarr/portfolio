...
export default function PortfolioListBlock(params) {
    ...
    return (
        ...
        style={thumbnailStyling} onClick={handleClick}>
            <div className="flex flex-col justify-end w-full lg:w-fit  p-4 bg-gradient-to-b  lg:bg-gradient-to-r to-transparent from-slate-600 lg:from-transparent group-hover:lg:from-slate-600 ease-in duration-200">
