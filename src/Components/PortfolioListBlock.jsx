...
export default function PortfolioListBlock(params) {
    ...
    return (
        ...
        style={thumbnailStyling} onClick={handleClick}>
            <div className="flex flex-col justify-end w-fit  p-4 group-hover:bg-gradient-to-r  group-hover:lg:bg-gradient-to-L to-transparent from-slate-600 ease-in duration-200">
